...
/* ## ---------------- ## */
     ...
     * up to 'kbits_rate' kbps of traffic is accepted, with a maximum accumulative
     * burst size of 'kbits' kb;
     * up to 'kpkts' kpps of traffic is accepted, with a maxiumum accumulative
     * burst size of 'kpkts' kilo packets.
     *
